  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent className="w-full sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl flex flex-col h-dvh p-0">
          <SheetHeader className="px-3 md:px-4 py-2 md:py-3 border-b shrink-0">
          ...
          {validationErrors.length > 0 && (
            <div className="mx-3 md:mx-4 lg:mx-5 mt-2 p-3 rounded-lg bg-destructive/10 border border-destructive/20">
          ...
          <div className="flex-1 overflow-hidden">
              <ScrollArea className="h-full px-3 md:px-4 lg:px-5 py-2 md:py-3" tabIndex={-1}>
              <div className="space-y-2" tabIndex={-1}>
                {children}
              </div>
            </ScrollArea>
          </div>
          <SheetFooter className="px-3 md:px-4 py-2 border-t shrink-0">
            {isViewMode ? (
              <Button
