...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <Suspense fallback={<AuthSkeleton />}>
      <div className="h-dvh flex flex-col bg-background overflow-hidden transition-premium">
        <AuthHeader />
        <div
          className={cn(
            "min-h-dvh  bg-background  overflow-hidden transition-premium flex-1 flex items-center justify-center p-4 sm:p-6 overflow-y-auto",
          )}
        >
